...
advanceParticle : Particle -> Vector -> Float -> Particle
advanceParticle p f dt = 
  let
    a = (1/p.m) `times` f
...
advance us dt = 
  ...
  in
    map2 (\p f -> advanceParticle p f dt) us fs
...
mainWith sim = Signal.map2 view Window.dimensions 
